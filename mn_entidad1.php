...
<body>
    ...
    $sql="SELECT nombre_ent,tipo_ident_ent,numero_iden_ent,direccion_ent,telefonos_ent,ciudad_ent,email_ent,rol_ent,codigoeps_ent,contacto_ent FROM entidad WHERE id_entidad='$_SESSION[gid_entidad]'";
    $result=mysqli_query($conexion,$sql);
    $row=mysqli_fetch_row($result);
    $nombre_ent=$row[0];
    $tipo_ident_ent=$row[1];
    $numero_iden_ent=$row[2];
    $direccion_ent=$row[3];
    $telefonos_ent=$row[4];
    $ciudad_ent=$row[5];
    $email_ent=$row[6];
...
<script language="javascript">
        ...
        $(document).ready(function(){
            //$("#btn_nuevo").click(function(){
                ...
                $.ajax({
                    type:"POST",
                    data:datos,
                    url:"procesos/editarregistro1.php",
                    success:function(r){
                        if(r==1){
    ...
    function mostrardatos(){
        document.form1.nombre_ent.value='<?php echo $nombre_ent;?>'
        document.form1.tipo_ident_ent.value='<?php echo $tipo_ident_ent;?>'
        document.form1.numero_iden_ent.value='<?php echo $numero_iden_ent;?>'
        document.form1.direccion_ent.value='<?php echo $direccion_ent;?>'
        document.form1.telefonos_ent.value='<?php echo $telefonos_ent;?>'
        document.form1.ciudad_ent.value='<?php echo $ciudad_ent;?>'
        document.form1.email_ent.value='<?php echo $email_ent;?>'
        document.form1.rol_ent.value='<?php echo $rol_ent;?>'
        document.form1.codigoeps_ent.value='<?php echo $codigoeps_ent;?>'
        document.form1.contacto_ent.value='<?php echo $contacto_ent;?>'
