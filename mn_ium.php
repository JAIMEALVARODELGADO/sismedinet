...
<body>
            ...
            <div class="col-sm-12">
                <div class="card text-left">
                    <div class="card-header">
                        <h4>Medicamentos IUM</h4>
                        <h6>Gestión de medicamentos según IUM</h6>
                    </div>
	...
	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalnuevoperiodo">
    <span class="fas fa-plus"></span> Nuevo Periodo
	</button>
    <!-- Modal Nuevo -->
